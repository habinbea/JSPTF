                    ...
                    <div class="col">
                        <a href="view.jsp?id=${tf.tfid}" class="card-link">
                            <div class="card shadow-sm">
                                <img src="${pageContext.request.contextPath}/upload/${tf.tfmotifimage}" alt="${pageContext.request.contextPath}/upload/${tf.tfmotifimage}" class="bd-placeholder-img card-img-top" width="100%" height="225"/>
